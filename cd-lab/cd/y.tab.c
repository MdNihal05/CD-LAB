...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from post.y  */
...
static const short yyprhs[] = {     0,
     0,     2,     3,     8,     9,    14,    16,    17,    22,    23,
    28,    30,    31,    36,    37,    41
};

static const short yyrhs[] = {    12,
     0,     0,    12,     4,    13,    15,     0,     0,    12,     5,
    14,    15,     0,    15,     0,     0,    15,     6,    16,    18,
     0,     0,    15,     7,    17,    18,     0,    18,     0,     0,
     9,    12,    19,    10,     0,     0,     5,    20,    18,     0,
     3,     0
};
...
static const short yyrline[] = { 0,
    13,    14,    14,    15,    15,    16,    18,    18,    19,    19,
    20,    22,    23,    23,    23,    24
};

static const char * const yytname[] = {   "$","error","$illegal.","ID","'+'",
"'-'","'*'","'/'","UMINUS","'('","')'","S","E","@1","@2","T","@3","@4","F","@5",
"@6",""
};
#endif

static const short yyr1[] = {     0,
    11,    13,    12,    14,    12,    12,    16,    15,    17,    15,
    15,    19,    18,    20,    18,    18
};
...
static const short yydefact[] = {     0,
    16,    14,     0,     1,     6,    11,     0,    12,     2,     4,
     7,     9,    15,     0,     0,     0,     0,     0,    13,     3,
     5,     8,    10,     0,     0,     0
};

static const short yydefgoto[] = {    24,
     4,    15,    16,     5,    17,    18,     6,    14,     7
};

static const short yypact[] = {    -2,
-32768,-32768,    -2,     0,     2,-32768,    -2,     0,-32768,-32768,
-32768,-32768,-32768,    -8,    -2,    -2,    -2,    -2,-32768,     2,
     2,-32768,-32768,     6,    14,-32768
};

static const short yypgoto[] = {-32768,
    12,-32768,-32768,    -3,-32768,-32768,    -7,-32768,-32768
};
...
static const short yytable[] = {    13,
     1,    19,     2,     9,    10,    25,     3,    11,    12,    22,
    23,    20,    21,    26,     8
};

static const short yycheck[] = {     7,
     3,    10,     5,     4,     5,     0,     9,     6,     7,    17,
    18,    15,    16,     0,     3
};
